# Play-Nine
This is a game similar to shut-box.  

Created while following along to the pluralsight course "React.js: Getting Started" - by Samer Buna.  Functionality has been added beyond demo
